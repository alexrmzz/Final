...
<div class="container">
		...
		<br>
			...
			<nav class="menu">
				<a href="VentasRegistroA.php" target="_self">Regresar</a>
        <a href="MenuA.html" target="_self">Regresar al Menu</a>
			</nav>
    		</div>
    </header>
...
<form action="whatsapp.php" method="POST">
    ...
    <form action="RegistroF_sp.php" method="post">
    <h4>Registro Familiar</h4>
      ...
      <input class="controlsnac" type="date" name="fnacimiento" placeholder="Fecha de nacimiento" required>
      <h5>Pais de Origen: </h5>
      <input class="controls" type="text" name="pais_origen" placeholder="Pais de Origen" required>
      <h5>Residencia: </h5>
      <input class="controls" type="text" name="ciudad" placeholder="Ciudad" required>
      <h5>Parentesco: </h5>
      <select class="controlsn" name="parentesco">
